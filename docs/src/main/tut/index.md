...
s"""
 ...
 || [`$squantsModuleName`][squants-module]        | squants $squantsVersion        | &#10003; ${squantsJvmCrossScalaVersions.map(minorVersion).mkString(", ")}    | &#10003; 0.6 (${squantsJsCrossScalaVersions.map(minorVersion).mkString(", ")})    | &#65794;                                                                           |
 |
