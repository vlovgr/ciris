...
s"""
 ...
 || [`$refinedModuleName`][refined-module]        | refined $refinedVersion        | &#10003; ${refinedCrossScalaVersions.map(minorVersion).mkString(", ")}    |
 || [`$spireModuleName`][spire-module]            | spire $spireVersion            | &#10003; ${spireCrossScalaVersions.map(minorVersion).mkString(", ")}      |
 || [`$squantsModuleName`][squants-module]        | squants $squantsVersion        | &#10003; ${squantsCrossScalaVersions.map(minorVersion).mkString(", ")}    |
 |
