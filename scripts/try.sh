...
~/.coursier/coursier launch -q -P \
  ...
  is.cir:ciris-core_2.12:0.4.2 \
  is.cir:ciris-enumeratum_2.12:0.4.2 \
  is.cir:ciris-generic_2.12:0.4.2 \
  is.cir:ciris-refined_2.12:0.4.2 \
  is.cir:ciris-spire_2.12:0.4.2 \
  is.cir:ciris-squants_2.12:0.4.2 \
