...
~/.coursier/coursier launch -q -P -M ammonite.Main \
  ...
  is.cir:ciris-cats_2.12:0.10.1 \
  is.cir:ciris-cats-effect_2.12:0.10.1 \
  is.cir:ciris-core_2.12:0.10.1 \
  is.cir:ciris-enumeratum_2.12:0.10.1 \
  is.cir:ciris-generic_2.12:0.10.1 \
  is.cir:ciris-refined_2.12:0.10.1 \
  is.cir:ciris-spire_2.12:0.10.1 \
  is.cir:ciris-squants_2.12:0.10.1 \
  -- --predef-code "\
